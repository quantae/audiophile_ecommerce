...
import {
  ProductDescription,
  ProductTitle,
} from "../../feature/product_description/ProductDescription";
...
export const VariantB = ({ itemImage = imageSpeakerZX7, title, onClick }) => (
...
export const VariantC = ({ itemImage = imageEarphonesYX1, title, onClick }) => (
